...
<html lang="en">
    <head>
        ...
        <![endif]-->
        <link rel="stylesheet" href="css/backend/ace-skins.min.css" />
        ...
        <script src="js/backend/ace-extra.min.js"></script>
		...
		<!--[if IE]>
                ...
                <![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='js/backend/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
	...
	<body class="no-skin">
		...
		<div id="navbar" class="navbar navbar-default">
			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					...
					<a href="sistema.php" class="navbar-brand">
						<small>
							<i class="fa fa-leaf"></i>
							E-Imóves <strong>Admin</strong>
						</small>
					</a>
			...
			<div id="sidebar" class="sidebar responsive">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						...
						<ul class="submenu">
							<li class="">
								<a href="sistema.php?action=imovellista">
									<i class="menu-icon fa fa-caret-right"></i>
									Imóveis
								</a>
							...
							<li class="">
								<a href="sistema.php?action=clientelista">
									<i class="menu-icon fa fa-caret-right"></i>
									Clientes
								</a>
							...
							<li class="">
								<a href="sistema.php?action=colaboradorlista">
									<i class="menu-icon fa fa-caret-right"></i>
									Colaboradores
								</a>
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="sistema.php?action=configuracoes">
									<i class="menu-icon fa fa-caret-right"></i>
									Configurações
								</a>
                        ...
                        <div class="main-content">
                            ...
                            <?php
                                if(isset ($_GET['action'])) {
                                    Utilitarios::mostraPageBackend($_GET['action']);
                                } else {                
                                    include_once 'app/view/backend/home.php';
                                }
                            ?>  
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">E-Imóves</span>
                                                        <strong>Admin</strong> &copy; 2014-2015
						</span>
		...
		<script src="js/backend/jquery.dataTables.bootstrap.js"></script>
		...
		<script type="text/javascript">
			jQuery(function($) {
                ...
                <!-- page specific plugin scripts -->
		<script src="js/backend/fuelux/fuelux.wizard.min.js"></script>
		<script src="js/backend/jquery.validate.min.js"></script>
		<script src="js/backend/additional-methods.min.js"></script>
		<script src="js/backend/bootbox.min.js"></script>
		<script src="js/backend/jquery.maskedinput.min.js"></script>
		<script src="js/backend/select2.min.js"></script>
                
                <!-- ace scripts CARREGANDO DUAS VEZES ANALISAR-->
		<script src="js/backend/ace-elements.min.js"></script>
		<script src="js/backend/ace.min.js"></script>
			...
			jQuery(function($) {
				...
				.on('finished', function(e) {
					bootbox.dialog({
						message: "<strong>Aguarde</strong>. O seu anúncio está sendo publicado!", 
						buttons: {
							"success" : {
								"label" : "OK",
		...
		<![endif]-->
		<script src="js/backend/jquery-ui.custom.min.js"></script>
		<script src="js/backend/jquery.ui.touch-punch.min.js"></script>
		<script src="js/backend/jquery.easypiechart.min.js"></script>
		<script src="js/backend/jquery.sparkline.min.js"></script>
		<script src="js/backend/flot/jquery.flot.min.js"></script>
		<script src="js/backend/flot/jquery.flot.pie.min.js"></script>
		<script src="js/backend/flot/jquery.flot.resize.min.js"></script>                                
		...
		<link rel="stylesheet" href="js/backend/themes/sunburst.css" />
		<script type="text/javascript"> ace.vars['base'] = '..'; </script>
		<script src="js/backend/ace/ace.onpage-help.js"></script>
		<script src="js/backend/rainbow.js"></script>
		<script src="js/backend/language/generic.js"></script>
		<script src="js/backend/language/html.js"></script>
		<script src="js/backend/language/css.js"></script>
		<script src="js/backend/language/javascript.js"></script>
                <!--<script src="../assets/js/jquery-ui.custom.min.js"></script>-->
		<!--<script src="../assets/js/jquery.ui.touch-punch.min.js"></script>-->
		<script src="js/backend/chosen.jquery.min.js"></script>
		<!--<script src="js/backend/fuelux.spinner.min.js"></script>-->
		<!--<script src="js/backend/bootstrap-datepicker.min.js"></script>-->
		<!--<script src="js/backend/bootstrap-timepicker.min.js"></script>-->
		<!--<script src="js/backend/moment.min.js"></script>-->
		<!--<script src="js/backend/daterangepicker.min.js"></script>-->
		<!--<script src="js/backend/bootstrap-datetimepicker.min.js"></script>-->
		<script src="js/backend/bootstrap-colorpicker.min.js"></script>
		<script src="js/backend/jquery.knob.min.js"></script>
		<script src="js/backend/jquery.autosize.min.js"></script>
		<script src="js/backend/jquery.inputlimiter.1.3.1.min.js"></script>
		<script src="js/backend/jquery.maskedinput.min.js"></script>
		<script src="js/backend/bootstrap-tag.min.js"></script>
