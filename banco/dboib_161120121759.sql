...
-- Dumping data for table dbopcaoimovel.endcidade: ~5,530 rows (approximately)
...
-- Dumping data for table dbopcaoimovel.imovel: ~0 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=260 DEFAULT CHARSET=utf8 COMMENT='associa uma determinada caracteristica a um imovel';

-- Dumping data for table dbopcaoimovel.imovelcaracteristica: ~0 rows (approximately)
...
-- Dumping data for table dbopcaoimovel.imovelfoto: ~0 rows (approximately)
...
-- Dumping data for table dbopcaoimovel.pessoa: ~1 rows (approximately)
