...
-- Dumping data for table dbopcaoimovel.anuncio: ~0 rows (approximately)
...
-- Dumping data for table dbopcaoimovel.endcidade: ~5,292 rows (approximately)
...
-- Dumping data for table dbopcaoimovel.imovel: ~1 rows (approximately)
...
INSERT INTO `imovel` (`idImovel`, `codigo`, `idCategoria`, `idPessoaProprietario`, `idProprietarioImovel`, `descricao`, `area`, `cep`, `logradouro`, `numLogradouro`, `complemento`, `pontoReferencia`, `cidade`, `uf`, `bairro`, `pais`, `excluido`, `observacao`, `dataCadastro`) VALUES
	(1, '123', 2, 1, 2, 'Apartamento Alameda dos Eucaliptos', 56, '59151610', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de referencia', 'Parnamirim', 'RN', 'Nova Parnamirim', 'Brasil', 'N', 'observa̵̤es do apartamento', '2012-11-19 20:31:27');
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='associa uma determinada caracteristica a um imovel';

-- Dumping data for table dbopcaoimovel.imovelcaracteristica: ~6 rows (approximately)
...
-- Dumping data for table dbopcaoimovel.pessoa: ~2 rows (approximately)
...
INSERT INTO `pessoa` (`idPessoa`, `idPessoaProprietario`, `tipo`, `razao`, `fantasia`, `cpf_cnpj`, `rg_ie`, `dtNascimento`, `idEstadoCivil`, `flagCliente`, `flagCorretor`, `flagImobiliaria`, `creci`, `genero`, `dtCadastro`, `dtUltimaAlteracao`, `cep`, `logradouro`, `numLogradouro`, `complemento`, `pontoReferencia`, `bairro`, `cidade`, `uf`, `pais`, `observacao`, `visivel`, `telefone`, `fax`, `celular`, `email`, `site`) VALUES
	(1, 1, 'F', 'Administrador do Sistema', 'admin', '05414577480', NULL, '2010-01-01', NULL, 'S', 'N', 'N', NULL, 'M', '0000-00-00 00:00:00', '2012-11-16 21:28:37', NULL, '1', 's/n', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL),
	(2, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '002267087', '1985-12-05', 1, 'S', 'N', 'N', NULL, 'M', NULL, NULL, '59151610', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Nova Parnamirim', 'Parnamirim', 'AC', 'Brasil', 'observa̵̤es', 0, '(84) 3553-0026', '(11) 1111-1111', '(11) 1111-1111', 'junior_melo85@hotmail.com', 'site');
