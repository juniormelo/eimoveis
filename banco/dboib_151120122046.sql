...
-- Dumping database structure for dbopcaoimovel
DROP DATABASE IF EXISTS `dbopcaoimovel`;
CREATE DATABASE IF NOT EXISTS `dbopcaoimovel` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `dbopcaoimovel`;


-- Dumping structure for table dbopcaoimovel.agenda
DROP TABLE IF EXISTS `agenda`;
CREATE TABLE IF NOT EXISTS `agenda` (
  `idCompromisso` int(10) NOT NULL auto_increment,
  `idCategoria` int(10) NOT NULL,
  `titulo` varchar(50) NOT NULL,
  `prioridade` enum('B','M','A') NOT NULL default 'M',
...
-- Dumping data for table dbopcaoimovel.agenda: ~0 rows (approximately)
/*!40000 ALTER TABLE `agenda` DISABLE KEYS */;
/*!40000 ALTER TABLE `agenda` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.agendacategoria
...
-- Dumping data for table dbopcaoimovel.agendacategoria: ~0 rows (approximately)
/*!40000 ALTER TABLE `agendacategoria` DISABLE KEYS */;
/*!40000 ALTER TABLE `agendacategoria` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.anuncio
...
CREATE TABLE IF NOT EXISTS `anuncio` (
  ...
  `qtdVisita` int(10) NOT NULL default '0',
  `dataIni` datetime default NULL,
  `dataFim` datetime default NULL,
  `status` char(1) default NULL,
  `motivoStatus` varchar(100) default NULL,
...
-- Dumping data for table dbopcaoimovel.anuncio: ~3 rows (approximately)
/*!40000 ALTER TABLE `anuncio` DISABLE KEYS */;
INSERT INTO `anuncio` (`idAnuncio`, `idImovel`, `idTipo`, `valor`, `qtdVisita`, `dataIni`, `dataFim`, `status`, `motivoStatus`, `visivel`) VALUES
	(1, 1, 1, 1200.00, 79, '2012-09-02 00:00:00', '2012-09-08 00:00:00', 'a', NULL, 1),
	(2, 1, 1, 79087.00, 0, '2012-09-30 00:00:00', '2012-10-06 00:00:00', 'b', NULL, 1),
	(3, 2, 5, 200000.00, 12, '2012-09-11 00:00:00', '2012-10-05 00:00:00', 'a', NULL, 1);
/*!40000 ALTER TABLE `anuncio` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.anuncioproposta
...
-- Dumping data for table dbopcaoimovel.anuncioproposta: ~2 rows (approximately)
/*!40000 ALTER TABLE `anuncioproposta` DISABLE KEYS */;
INSERT INTO `anuncioproposta` (`idProposta`, `idAnuncio`, `dataProposta`, `proposta`, `nome`, `email`, `telefone`, `dataResposta`, `resposta`) VALUES
	(1, 1, '2012-08-30 19:36:45', 'Teste de envio de proposta', 'Diego', 'diehpb@gmail.com', '8488070819', NULL, NULL),
	(2, 1, '2012-09-05 17:24:08', '', '', '', '', NULL, NULL);
/*!40000 ALTER TABLE `anuncioproposta` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.anunciotipo
DROP TABLE IF EXISTS `anunciotipo`;
CREATE TABLE IF NOT EXISTS `anunciotipo` (
  `idTipo` int(10) NOT NULL auto_increment,
  `descricao` varchar(50) NOT NULL COMMENT 'os tipos dos anuncios podem ser: aluguel, compra, venda etc.',
  PRIMARY KEY  (`idTipo`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- Dumping data for table dbopcaoimovel.anunciotipo: ~5 rows (approximately)
...
-- Dumping structure for table dbopcaoimovel.cargo
...
-- Dumping data for table dbopcaoimovel.cargo: ~2 rows (approximately)
...
-- Dumping structure for table dbopcaoimovel.configuracao
DROP TABLE IF EXISTS `configuracao`;
CREATE TABLE IF NOT EXISTS `configuracao` (
  `frontEndOnline` enum('S','N') NOT NULL default 'N',
  `backEndOnline` enum('S','N') NOT NULL default 'N'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- Dumping data for table dbopcaoimovel.configuracao: 0 rows
/*!40000 ALTER TABLE `configuracao` DISABLE KEYS */;
/*!40000 ALTER TABLE `configuracao` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.contato
...
-- Dumping data for table dbopcaoimovel.contato: ~0 rows (approximately)
/*!40000 ALTER TABLE `contato` DISABLE KEYS */;
/*!40000 ALTER TABLE `contato` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.contatotipo
DROP TABLE IF EXISTS `contatotipo`;
CREATE TABLE IF NOT EXISTS `contatotipo` (
  `idTipo` int(10) NOT NULL auto_increment,
  `descricao` varchar(30) NOT NULL COMMENT 'skype,email,telefone dentre outros',
  PRIMARY KEY  (`idTipo`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- Dumping data for table dbopcaoimovel.contatotipo: ~5 rows (approximately)
...
-- Dumping structure for table dbopcaoimovel.contrato
...
-- Dumping data for table dbopcaoimovel.contrato: ~0 rows (approximately)
/*!40000 ALTER TABLE `contrato` DISABLE KEYS */;
/*!40000 ALTER TABLE `contrato` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.contratodetalhes
...
-- Dumping data for table dbopcaoimovel.contratodetalhes: ~0 rows (approximately)
/*!40000 ALTER TABLE `contratodetalhes` DISABLE KEYS */;
/*!40000 ALTER TABLE `contratodetalhes` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.contratotipo
...
CREATE TABLE IF NOT EXISTS `contratotipo` (
  ...
  `receita` enum('S','N') NOT NULL default 'S' COMMENT 'S - indica que que o tipo cadastrado é uma receita, N-indica que não é uma receita consequentimente é uma despesa',
  PRIMARY KEY  (`idContratoTipo`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

-- Dumping data for table dbopcaoimovel.contratotipo: ~4 rows (approximately)
...
-- Dumping structure for table dbopcaoimovel.empreenddetalhesdependencia
...
-- Dumping data for table dbopcaoimovel.empreenddetalhesdependencia: ~0 rows (approximately)
/*!40000 ALTER TABLE `empreenddetalhesdependencia` DISABLE KEYS */;
/*!40000 ALTER TABLE `empreenddetalhesdependencia` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.empreendimento
...
-- Dumping data for table dbopcaoimovel.empreendimento: ~0 rows (approximately)
/*!40000 ALTER TABLE `empreendimento` DISABLE KEYS */;
/*!40000 ALTER TABLE `empreendimento` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.empreendimentodependencia
...
-- Dumping data for table dbopcaoimovel.empreendimentodependencia: ~0 rows (approximately)
/*!40000 ALTER TABLE `empreendimentodependencia` DISABLE KEYS */;
/*!40000 ALTER TABLE `empreendimentodependencia` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.empreendimentoreserva
...
CREATE TABLE IF NOT EXISTS `empreendimentoreserva` (
  ...
  `status` enum('A','C','D') NOT NULL default 'A' COMMENT 'A: Ativo - quando for criada a reserva, C: Concluido - quando der certo a reserva,  D: Desativado - quando execeder o tempo da reserva',
...
-- Dumping data for table dbopcaoimovel.empreendimentoreserva: ~0 rows (approximately)
/*!40000 ALTER TABLE `empreendimentoreserva` DISABLE KEYS */;
/*!40000 ALTER TABLE `empreendimentoreserva` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.empreendimentotipo
...
-- Dumping data for table dbopcaoimovel.empreendimentotipo: ~5 rows (approximately)
...
-- Dumping structure for table dbopcaoimovel.endbairro
...
-- Dumping data for table dbopcaoimovel.endbairro: ~199 rows (approximately)
...
-- Dumping structure for table dbopcaoimovel.endcidade
...
-- Dumping data for table dbopcaoimovel.endcidade: ~5,562 rows (approximately)
...
-- Dumping structure for table dbopcaoimovel.endlogradouro
...
CREATE TABLE IF NOT EXISTS `endlogradouro` (
  ...
  `numLogradouro` varchar(10) default NULL,
...
-- Dumping data for table dbopcaoimovel.endlogradouro: ~9 rows (approximately)
...
-- Dumping structure for table dbopcaoimovel.endpais
...
-- Dumping data for table dbopcaoimovel.endpais: ~1 rows (approximately)
...
-- Dumping structure for table dbopcaoimovel.enduf
...
-- Dumping data for table dbopcaoimovel.enduf: ~27 rows (approximately)
...
-- Dumping structure for table dbopcaoimovel.estadocivil
...
-- Dumping data for table dbopcaoimovel.estadocivil: ~4 rows (approximately)
...
-- Dumping structure for table dbopcaoimovel.formaspagto
...
-- Dumping data for table dbopcaoimovel.formaspagto: ~0 rows (approximately)
/*!40000 ALTER TABLE `formaspagto` DISABLE KEYS */;
/*!40000 ALTER TABLE `formaspagto` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.funcionario
...
CREATE TABLE IF NOT EXISTS `funcionario` (
  ...
  `motivoDemissao` varchar(300) default NULL,
  `salario` decimal(10,2) default '0.00',
  `carteiraTrab` varchar(18) default NULL,
  `pis_pasep` varchar(18) default NULL,
  `orgaoEmissor` varchar(10) default NULL,
  `dtExpedicao` date default NULL,
  ...
  CONSTRAINT `FK_Funcionario_PessoaFisica` FOREIGN KEY (`idFuncionario`) REFERENCES `pessoafisica` (`idPessoaFisica`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table dbopcaoimovel.funcionario: ~2 rows (approximately)
/*!40000 ALTER TABLE `funcionario` DISABLE KEYS */;
INSERT INTO `funcionario` (`idFuncionario`, `dtCadastro`, `dtAdmissao`, `dtDemissao`, `motivoDemissao`, `salario`, `carteiraTrab`, `pis_pasep`, `orgaoEmissor`, `dtExpedicao`, `idCargo`, `cnh`, `observacao`) VALUES
	(10, '2012-08-02 19:28:24', '2012-08-02', NULL, NULL, 1200000.00, '3454', '132', '', NULL, 2, '', ''),
	(11, '2012-08-02 19:59:32', NULL, NULL, NULL, 123213.00, '34543', '', '', NULL, 1, '', '');
/*!40000 ALTER TABLE `funcionario` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.imovel
...
-- Dumping data for table dbopcaoimovel.imovel: ~41 rows (approximately)
...
INSERT INTO `imovel` (`idImovel`, `codigo`, `idCategoria`, `idPessoaProprietario`, `idProprietarioImovel`, `descricao`, `area`, `cep`, `logradouro`, `numLogradouro`, `complemento`, `pontoReferencia`, `cidade`, `uf`, `bairro`, `pais`, `excluido`, `observacao`, `dataCadastro`) VALUES
	(1, '', 2, 13, 13, 'Descricao', 3434, '', '2', '', '', '', '', '', '', '', 'N', '&nbsp', NULL),
	(2, '', 5, 16, 19, 'Imóvel novo, condomínio fechado', 150, '', '14', '', '', '', '', '', '', '', 'N', '100% finaciado pela caixa econômica', NULL),
	(3, 'a', 2, 1, 1, 'Apartamento Alameda dos Eucaliptos', 56, '59151-61', 'Avenida Ayrton Senna', '1', 'complemento', '', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'observaÃ§Ã£o do imovel', '2012-10-28 21:36:24'),
	(4, '', 2, 1, 1, 'Descricao', 3434, '59151-61', 'Avenida Ayrton Senna', '2', '', NULL, 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'Â ', '2012-10-29 20:51:52'),
	(5, '', 3, 1, 1, 'Descricao', 3434, '59151-61', 'Avenida Ayrton Senna', '3', 'complemento', NULL, 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'Â ', '2012-10-29 20:52:20'),
	(6, '0001', 2, 1, 1, 'Apartamento Del camp', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', NULL, 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'apartamento del campo parnamirim', '2012-11-03 15:43:16'),
	(7, '0001', 2, 1, 1, 'Apartamento Del campo', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', NULL, 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'apartamento del campo parnamirim', '2012-11-03 15:49:43'),
	(8, '0001', 2, 1, 1, 'Apartamento Del campo', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de refencia', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'apartamento del campo parnamirim', '2012-11-05 21:57:42'),
	(9, '0001', 2, 1, 1, 'Apartamento Del campo', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', NULL, 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', NULL, 'apartamento del campo parnamirim', '2012-11-07 20:52:14'),
	(10, '0001', 2, 1, 1, 'Apartamento Del campo', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', NULL, 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', NULL, 'apartamento del campo parnamirim', '2012-11-07 20:53:37'),
	(11, '0001', 2, 1, 1, 'Apartamento Del campo', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', NULL, 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', NULL, 'apartamento del campo parnamirim', '2012-11-07 20:53:53'),
	(12, '0001', 2, 1, 1, 'Apartamento Del campo', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', NULL, 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', NULL, 'apartamento del campo parnamirim', '2012-11-07 22:05:15'),
	(13, '0001', 2, 1, 36, 'Apartamento Del campo', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', NULL, 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', NULL, 'apartamento del campo parnamirim', '2012-11-07 22:19:39'),
	(14, '0001', 2, 1, 37, 'Apartamento Del campo', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', NULL, 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', NULL, 'apartamento del campo parnamirim', '2012-11-07 22:20:18'),
	(15, '0001', 2, 1, 38, 'Apartamento Del campo', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', NULL, 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', NULL, 'apartamento del campo parnamirim', '2012-11-07 22:21:52'),
	(16, '0001', 2, 1, 39, 'Apartamento Del campo', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', NULL, 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', NULL, 'apartamento del campo parnamirim', '2012-11-07 22:23:51'),
	(17, '0001', 2, 1, 40, 'Apartamento Del campo', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', NULL, 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', NULL, 'apartamento del campo parnamirim', '2012-11-07 22:24:13'),
	(18, '0001', 2, 1, 41, 'Apartamento Del campo teste', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de refencia', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'apartamento del campo parnamirim', '2012-11-10 21:17:05'),
	(19, '0001', 2, 1, 42, 'Apartamento Del campo teste', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de refencia', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'apartamento del campo parnamirim', '2012-11-10 21:26:22'),
	(20, '0001', 2, 1, 43, 'Apartamento Del campo teste', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de refencia', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'apartamento del campo parnamirim', '2012-11-10 21:26:47'),
	(21, '0001', 2, 1, 44, 'Apartamento Del campo teste', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de refencia', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'apartamento del campo parnamirim', '2012-11-10 21:26:56'),
	(22, '0001', 2, 1, 45, 'Apartamento Del campo teste', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de refencia', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'apartamento del campo parnamirim', '2012-11-10 21:27:55'),
	(23, '0001', 2, 1, 46, 'Apartamento Del campo teste', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de refencia', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'apartamento del campo parnamirim', '2012-11-10 21:28:23'),
	(24, '123', 2, 1, 47, 'Apartamento teste pessoa fisica', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Parnamirim', 'RN', 'Nova Parnamirim', 'Brasil', 'S', 'observaÃ§Ã£o', '2012-11-10 21:39:08'),
	(25, '123', 2, 1, 48, 'Apartamento teste pessoa fisica', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'observaÃ§Ã£o', '2012-11-10 21:47:00'),
	(26, '123', 2, 1, 49, 'Apartamento teste pessoa fisica', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'observaÃ§Ã£o', '2012-11-10 21:47:06'),
	(27, '123', 2, 1, 50, 'Apartamento teste pessoa fisica', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'observaÃ§Ã£o', '2012-11-10 21:47:15'),
	(28, '123', 2, 1, 51, 'Apartamento teste pessoa fisica', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'observaÃ§Ã£o', '2012-11-10 21:47:19'),
	(29, '123', 2, 1, 52, 'Apartamento teste pessoa fisica', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'observaÃ§Ã£o', '2012-11-10 21:47:50'),
	(30, '123', 2, 1, 53, 'Apartamento teste pessoa fisica', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'observaÃ§Ã£o', '2012-11-10 21:47:56'),
	(31, '123', 2, 1, 54, 'Apartamento teste pessoa fisica', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'observaÃ§Ã£o', '2012-11-10 21:51:18'),
	(32, '123', 2, 1, 55, 'Apartamento teste pessoa fisica', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'observaÃ§Ã£o', '2012-11-10 21:51:34'),
	(33, '1234', 2, 1, 56, 'Apartamento Le Blanc', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'N', 'observaÃ§Ã£o', '2012-11-10 22:09:34'),
	(34, '123', 2, 1, 57, 'Apartamento teste pessoa fisica', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'observaÃ§Ã£o', '2012-11-10 22:09:41'),
	(35, '123', 2, 1, 58, 'Apartamento teste pessoa fisica', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'observaÃ§Ã£o', '2012-11-10 22:09:44'),
	(36, '123', 2, 1, 59, 'Apartamento teste pessoa fisica', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'observaÃ§Ã£o', '2012-11-10 22:09:46'),
	(37, '123', 2, 1, 60, 'Apartamento teste pessoa fisica', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'observaÃ§Ã£o', '2012-11-10 22:09:48'),
	(38, '1234', 2, 1, 62, 'Apartamento Le Blanc', 56, '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Parnamirim', 'RN', 'Nova Parnamirim', 'Brasil', 'S', 'observaÃ§Ã£o', '2012-11-10 23:15:19'),
	(39, 'abc001', 5, 1, 62, 'casa em JandaÃ­ra', 100, '59594000', 'av aristofanis fernandes', '527', 'complemento', 'ponto de referencia', 'JandaÃ­ra', 'RN', 'centro', 'Brasil', 'N', 'observaÃ§Ãµes', '2012-11-11 13:05:52'),
	(40, '1234', 2, 1, 1, 'Apartamento Le Black', 56, '5915161', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'N', 'observaÃ§Ã£o', '2012-11-11 18:08:40'),
	(41, '1234', 2, 1, 65, 'Apartamento Le Blanc', 56, '5915161', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de ref', 'Parnamirim', 'AC', 'Nova Parnamirim', 'Brasil', 'S', 'observaÃ§Ã£o', '2012-11-11 21:00:58');
/*!40000 ALTER TABLE `imovel` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.imovelcaracteristica
...
CREATE TABLE IF NOT EXISTS `imovelcaracteristica` (
  ...
  `descricao` varchar(100) default '0' COMMENT 'exemplo: quarto 3, banheiro 2',
...
) ENGINE=InnoDB AUTO_INCREMENT=256 DEFAULT CHARSET=utf8 COMMENT='associa uma determinada caracteristica a um imovel';

-- Dumping data for table dbopcaoimovel.imovelcaracteristica: ~76 rows (approximately)
...
INSERT INTO `imovelcaracteristica` (`idImovelCaracteristica`, `idImovel`, `idCaracteristica`, `descricao`) VALUES
	...
	(4, 1, 16, 'Info sala'),
	(5, 2, 18, '&nbsp'),
	(6, 2, 12, '3, sendo 1 lavabo'),
	(7, 2, 4, '&nbsp'),
	(8, 2, 8, 'R$ 150,00'),
	(9, 2, 15, '&nbsp'),
	(10, 2, 9, '4, sendo 1 suíte'),
	(11, 2, 16, '&nbsp'),
	(59, 7, 18, '1'),
	(60, 7, 12, '2'),
	(61, 7, 7, 'incluso'),
...
-- Dumping structure for table dbopcaoimovel.imovelcaracteristicatipo
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='cadastrar todos os tipos de caracteristica possiveis';

-- Dumping data for table dbopcaoimovel.imovelcaracteristicatipo: ~18 rows (approximately)
...
-- Dumping structure for table dbopcaoimovel.imovelcategoria
...
-- Dumping data for table dbopcaoimovel.imovelcategoria: ~38 rows (approximately)
...
-- Dumping structure for table dbopcaoimovel.imovelfavorito
...
-- Dumping data for table dbopcaoimovel.imovelfavorito: ~0 rows (approximately)
/*!40000 ALTER TABLE `imovelfavorito` DISABLE KEYS */;
/*!40000 ALTER TABLE `imovelfavorito` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.imovelfoto
...
-- Dumping data for table dbopcaoimovel.imovelfoto: ~15 rows (approximately)
/*!40000 ALTER TABLE `imovelfoto` DISABLE KEYS */;
INSERT INTO `imovelfoto` (`idFoto`, `idImovel`, `ordem`, `descricao`, `foto`) VALUES
	(1, 1, 0, NULL, 'b160ab9e-6ca8-4574-b868-fe07ad9f0017pp-img6.jpg'),
	(2, 1, 0, NULL, '4524a55a-32e3-45f0-869d-9f4ab42a8377Desert.jpg'),
	(3, 1, 1, NULL, '60399f5b-1d0d-445b-9cfc-2926faf381e8Koala.jpg'),
	(4, 1, 0, NULL, 'bba3b8b4-a67b-4f9f-9948-6d411a6f6891Lighthouse.jpg'),
	(6, 1, 0, NULL, '207f104f-e076-4476-bb55-398ca0dd39fePenguins.jpg'),
	(7, 2, 1, NULL, 'ad7b560b-e39f-4aa9-903d-d4997a33a44bDesert.jpg'),
	(8, 2, 0, NULL, '96e06b1a-2dfd-41c5-bc2c-778ffd7b9f36Chrysanthemum.jpg'),
	(9, 2, 0, NULL, 'eaaf691a-5e10-472e-be60-0b33af9daaddLighthouse.jpg'),
	(10, 2, 0, NULL, '499db134-bbda-4b9a-9809-264dd6af8c37Tulips.jpg'),
	(11, 3, 1, 'Penguins_1', '3_00f80cf6e44692186467e9f7b8d29528.jpg'),
	(12, 3, 2, 'Desert_2', '3_0a03b46ef2d8d7675e3d2936660bca63.jpg'),
	(13, 3, 3, 'Koala_3', '3_b9ffbf7230b56789cb69f1261cbdc33c.jpg'),
	(14, 6, 1, 'Penguins', '6_78c938c1882882238b3ca1387ded3b2c.jpg'),
	(15, 24, 1, 'Desert', '24_7e6da7068f4c4319c75767813b8b3ea5.jpg'),
	(16, 39, 1, 'Koala', '39_d399171af2b36499335376a1ce3b465c.jpg');
/*!40000 ALTER TABLE `imovelfoto` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.imovelsolicitado
...
-- Dumping data for table dbopcaoimovel.imovelsolicitado: ~0 rows (approximately)
/*!40000 ALTER TABLE `imovelsolicitado` DISABLE KEYS */;
/*!40000 ALTER TABLE `imovelsolicitado` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.noticias
DROP TABLE IF EXISTS `noticias`;
CREATE TABLE IF NOT EXISTS `noticias` (
  `idNoticia` int(10) NOT NULL auto_increment,
  `ativa` enum('S','N') default 'S',
...
-- Dumping data for table dbopcaoimovel.noticias: ~0 rows (approximately)
/*!40000 ALTER TABLE `noticias` DISABLE KEYS */;
/*!40000 ALTER TABLE `noticias` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.ofertacandidato
...
-- Dumping data for table dbopcaoimovel.ofertacandidato: ~0 rows (approximately)
/*!40000 ALTER TABLE `ofertacandidato` DISABLE KEYS */;
/*!40000 ALTER TABLE `ofertacandidato` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.ofertaemprego
...
CREATE TABLE IF NOT EXISTS `pessoa` (
  ...
  `cpf_cnpj` varchar(14) default NULL COMMENT 'armazena o cpf ou cnpj de acordo com o tipo da razao',
  `rg_ie` varchar(12) default NULL,
  `dtNascimento` date default NULL,
  `idEstadoCivil` int(11) default NULL,
  `flagCliente` enum('S','N') default 'N',
  `flagCorretor` enum('S','N') default 'N' COMMENT 'se é corretor',
  `flagImobiliaria` enum('S','N') default 'N',
  ...
  `logradouro` varchar(100) default NULL,
  `numLogradouro` varchar(10) default 's/n',
  `complemento` varchar(50) default NULL,
  `pontoReferencia` varchar(100) default NULL,
  `bairro` varchar(100) default NULL,
  `cidade` varchar(100) default NULL,
...
-- Dumping data for table dbopcaoimovel.pessoa: ~46 rows (approximately)
/*!40000 ALTER TABLE `pessoa` DISABLE KEYS */;
INSERT INTO `pessoa` (`idPessoa`, `idPessoaProprietario`, `tipo`, `razao`, `fantasia`, `cpf_cnpj`, `rg_ie`, `dtNascimento`, `idEstadoCivil`, `flagCliente`, `flagCorretor`, `flagImobiliaria`, `creci`, `genero`, `dtCadastro`, `dtUltimaAlteracao`, `cep`, `logradouro`, `numLogradouro`, `complemento`, `pontoReferencia`, `bairro`, `cidade`, `uf`, `pais`, `observacao`, `visivel`, `telefone`, `fax`, `celular`, `email`, `site`) VALUES
	(1, 1, 'F', 'Administrador do Sistema', 'admin', NULL, NULL, '2010-01-01', NULL, 'N', 'N', 'N', NULL, 'M', '0000-00-00 00:00:00', '2012-11-11 13:36:46', NULL, '1', 's/n', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL),
	(10, 13, 'F', 'Diego Henrique', 'Diego Henrique', NULL, NULL, '2010-01-01', NULL, 'N', 'N', 'N', NULL, 'M', '2012-08-02 00:00:00', '2012-11-11 13:36:46', NULL, '7', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 1, NULL, NULL, NULL, NULL, NULL),
	(11, 13, 'F', 'Rodolfo ', 'Rodolfo ', NULL, NULL, '2010-01-01', NULL, 'N', 'N', 'N', NULL, 'M', '2012-08-02 00:00:00', '2012-11-11 13:36:46', NULL, '8', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 1, NULL, NULL, NULL, NULL, NULL),
	(13, 13, 'F', 'Nova social', 'Nova fantasia', NULL, NULL, '2010-01-01', NULL, 'N', 'N', 'N', NULL, 'M', '2012-08-16 00:00:00', '2012-11-11 13:36:46', NULL, '10', NULL, NULL, 'Ponto', NULL, NULL, NULL, NULL, '', 1, NULL, NULL, NULL, NULL, 'www.i9pixel.com.br'),
	(16, 16, 'F', 'Padrão Imóveis', 'Padrão Imóveis', NULL, NULL, '2010-01-01', NULL, 'N', 'N', 'N', NULL, 'M', '2012-09-11 00:00:00', '2012-11-11 13:36:46', NULL, '13', NULL, NULL, '', NULL, NULL, NULL, NULL, '', 1, '8423445454', '', '', '', 'www.padraoimoveis.com.br'),
	(19, 16, 'F', 'Diego', 'Diego', NULL, NULL, '2010-01-01', NULL, 'S', 'N', 'N', NULL, 'M', '2012-09-13 00:00:00', '2012-11-11 13:36:46', NULL, '17', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 1, '8432063316', '', '8488070819', 'diehpb@gmail.com', NULL),
	(20, 20, 'F', 'Abreu Imóveis', '                    ', NULL, NULL, '2010-01-01', NULL, 'N', 'N', 'N', NULL, 'M', '2012-09-25 00:00:00', '2012-11-11 13:36:46', NULL, '18', NULL, NULL, 'Referência', NULL, NULL, NULL, NULL, '', 1, '8454523523', '', '', '', ''),
	(26, 1, 'F', 'jose selmo de melo junior', 'junior melo', NULL, NULL, '2010-01-01', NULL, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', NULL, 'Avenida Ayrton Senna', '123', 'complemento', 'ref pro', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'bla bla bla bla....', NULL, '111111', '1111', '80989080', 'junior_melo85@hotmail.com', 'meu site'),
	(28, 1, NULL, 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 1, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', NULL, 'Avenida Ayrton Senna', '123', 'complemento', 'referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'kjfdÃ§klajsdÃ§fkljaÃ§dslfkjaÃ§skdfjÃ§alksjdfÃ§aksjdfÃ§ajsdÃ§fkjaÃ§kfjÃ§alkjsdfÃ§lajdflÃ§ajdÃ§lfjadlÃ§jfÃ§aljfÃ§', NULL, '111111', '1111', '80989080', 'junior_melo85@hotmail.com', 'meu site'),
	(29, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', NULL, '', '', '', '', '', '', 'AC', '', '', NULL, '111111', '1111', '80989080', 'junior_melo85@hotmail.com', ''),
	(30, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', NULL, 'Avenida Ayrton Senna', '1111', 'complemento', 'referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ãµes', NULL, '111111', '1111', '80989080', 'junior_melo85@hotmail.com', 'meu site'),
	(31, 1, 'F', '', '', '', '', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', NULL, '', '', '', '', '', '', 'AC', '', '', NULL, '', '', '', '', ''),
	(32, 1, 'F', '', '', '', '', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', NULL, '', '', '', '', '', '', 'AC', '', '', NULL, '', '', '', '', ''),
	(33, 1, 'F', '', '', '', '', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', NULL, '', '', '', '', '', '', 'AC', '', '', NULL, '', '', '', '', ''),
	(34, 1, 'F', '', '', '', '', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', NULL, '', '', '', '', '', '', 'AC', '', '', NULL, '', '', '', '', ''),
	(35, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 4, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', NULL, 'Avenida Ayrton Senna', '1111', 'complemento', 'referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ãµes', NULL, '111111', '1111', '80989080', 'junior_melo85@hotmail.com', 'meu site'),
	(36, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 4, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', NULL, 'Avenida Ayrton Senna', '1111', 'complemento', 'referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ãµes', NULL, '111111', '1111', '80989080', 'junior_melo85@hotmail.com', 'meu site'),
	(37, 1, 'F', '', '', '', '', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', NULL, '', '', '', '', '', '', 'AC', '', '', NULL, '', '', '', '', ''),
	(38, 1, 'F', '', '', '', '', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', NULL, '', '', '', '', '', '', 'AC', '', '', NULL, '', '', '', '', ''),
	(39, 1, 'F', '', '', '', '', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', NULL, '', '', '', '', '', '', 'AC', '', '', NULL, '', '', '', '', ''),
	(40, 1, 'F', '', '', '', '', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', NULL, '', '', '', '', '', '', 'AC', '', '', NULL, '', '', '', '', ''),
	(41, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 1, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', NULL, 'Avenida Ayrton Senna', '123', 'bl g ap 303', 'prox', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ãµes', NULL, '111111', '1111', '80989080', 'junior_melo85@hotmail.com', 'junior_melo85@hotmail.com'),
	(42, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 1, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', '59151-61', 'Avenida Ayrton Senna', '123', 'bl g ap 303', 'prox', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ãµes', NULL, '111111', '1111', '80989080', 'junior_melo85@hotmail.com', 'junior_melo85@hotmail.com'),
	(43, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 1, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', '59151-61', 'Avenida Ayrton Senna', '123', 'bl g ap 303', 'prox', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ãµes', NULL, '111111', '1111', '80989080', 'junior_melo85@hotmail.com', 'junior_melo85@hotmail.com'),
	(44, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 1, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', '59151-61', 'Avenida Ayrton Senna', '123', 'bl g ap 303', 'prox', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ãµes', NULL, '111111', '1111', '80989080', 'junior_melo85@hotmail.com', 'junior_melo85@hotmail.com'),
	(45, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 1, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', '', 'Avenida Ayrton Senna', '123', 'bl g ap 303', 'prox', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ãµes', NULL, '111111', '1111', '80989080', 'junior_melo85@hotmail.com', 'junior_melo85@hotmail.com'),
	(46, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 1, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', '', 'Avenida Ayrton Senna', '123', 'bl g ap 303', 'prox', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ãµes', NULL, '111111', '1111', '80989080', 'junior_melo85@hotmail.com', 'junior_melo85@hotmail.com'),
	(47, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ã£o', NULL, '111111111111111', '111111111111111', '111111111111111', 'junior_melo85@hotmail.com', 'meu site'),
	(48, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ã£o', NULL, '111111111111111', '111111111111111', '111111111111111', 'junior_melo85@hotmail.com', 'meu site'),
	(49, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ã£o', NULL, '111111111111111', '111111111111111', '111111111111111', 'junior_melo85@hotmail.com', 'meu site'),
	(50, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ã£o', NULL, '111111111111111', '111111111111111', '111111111111111', 'junior_melo85@hotmail.com', 'meu site'),
	(51, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ã£o', NULL, '111111111111111', '111111111111111', '111111111111111', 'junior_melo85@hotmail.com', 'meu site'),
	...
	(58, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ã£o', NULL, '111111111111111', '111111111111111', '111111111111111', 'junior_melo85@hotmail.com', 'meu site'),
	(59, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ã£o', NULL, '111111111111111', '111111111111111', '111111111111111', 'junior_melo85@hotmail.com', 'meu site'),
	(60, 1, 'F', 'jose selmo de melo junior', 'JÃºnior Melo', '05414577480', '0002', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ã£o', NULL, '111111111111111', '111111111111111', '111111111111', 'junior_melo85@hotmail.com', 'meu site'),
	(61, 1, 'F', 'jose selmo de melo junior', 'junior melo', '05414577480', '0002', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, '2012-11-11 13:36:46', '59151-61', 'Avenida Ayrton Senna', '123', 'complemento', 'referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ã£o', NULL, '111111111111111', '111111111111111', '111111111111111', 'junior_melo85@hotmail.com', 'meu site'),
	(62, 1, 'F', 'jose selmo de melo junior', 'junior melo', '054.145.774-80', '0002', '1985-12-05', 2, 'N', 'N', 'N', NULL, 'F', NULL, NULL, '5915161', 'Avenida Ayrton Senna', '123', 'complemento', 'referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ã£o', NULL, '(84) 3553-0026', '(11) 1111-1111', '(11) 1111-1111', 'junior_melo85@hotmail.com', 'site'),
	(63, 1, 'F', 'jose selmo de melo junior', 'junior melo', '054.145.774-80', '0002', '1985-12-05', 1, 'N', 'N', 'N', NULL, 'M', NULL, NULL, '59151610', 'Avenida Ayrton Senna', '123', 'complemento', 'referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ãµes do proprietario!', NULL, '(88) 8888-8888', '(88) 8888-8888', '(88) 8888-8888', 'junior_melo85@hotmail.com', 'www'),
	(64, 1, 'F', 'jose selmo de melo junior', 'junior melo', '054.145.774-80', '002267087', '1985-12-05', 1, 'N', 'N', 'N', NULL, 'M', NULL, NULL, '59151610', 'Avenida Ayrton Senna', '123', 'complemento', 'referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ã£o', NULL, '(11) 1111-1111', '(11) 1111-1111', '(11) 1111-1111', 'junior_melo85@hotmail.com.com', 'meu site'),
	(65, 1, 'J', 'jose selmo de melo junior', 'junior melo', '05.414.577/480', '002267087', '1985-12-05', 1, 'N', 'N', 'N', NULL, 'M', NULL, NULL, '59151610', 'Avenida Ayrton Senna', '123', 'complemento', 'referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ã£o', NULL, '(11) 1111-1111', '(11) 1111-1111', '(11) 1111-1111', 'junior_melo85@hotmail.com.com', 'meu site');
/*!40000 ALTER TABLE `pessoa` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.pessoafisica
DROP TABLE IF EXISTS `pessoafisica`;
CREATE TABLE IF NOT EXISTS `pessoafisica` (
  `idPessoaFisica` int(10) NOT NULL,
  `idEstadoCivil` int(10) NOT NULL,
  `cpf` char(11) default NULL,
  `rg` varchar(15) default NULL,
  `dtNascimento` date default NULL,
  `flagCorretor` enum('S','N') default 'N',
  `creci` varchar(10) default NULL,
  PRIMARY KEY  (`idPessoaFisica`),
  UNIQUE KEY `cpf` (`cpf`),
  KEY `FK_EstadoCivil` (`idEstadoCivil`),
  CONSTRAINT `FK_EstadoCivil` FOREIGN KEY (`idEstadoCivil`) REFERENCES `estadocivil` (`idEstadoCivil`),
  CONSTRAINT `FK_pessoafisica_pessoa` FOREIGN KEY (`idPessoaFisica`) REFERENCES `pessoa` (`idPessoa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table dbopcaoimovel.pessoafisica: ~4 rows (approximately)
/*!40000 ALTER TABLE `pessoafisica` DISABLE KEYS */;
INSERT INTO `pessoafisica` (`idPessoaFisica`, `idEstadoCivil`, `cpf`, `rg`, `dtNascimento`, `flagCorretor`, `creci`) VALUES
	(10, 1, '12345678900', '12345', '1985-07-31', 'S', '123'),
	(11, 2, '09874324324', '1233', '2012-07-31', 'S', '1323'),
	(19, 1, '06000011122', '2323', '2012-09-17', 'N', NULL),
	(26, 2, '05414577480', '002267087', '0000-00-00', 'N', NULL);
/*!40000 ALTER TABLE `pessoafisica` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.pessoaimg
...
-- Dumping data for table dbopcaoimovel.pessoaimg: ~2 rows (approximately)
/*!40000 ALTER TABLE `pessoaimg` DISABLE KEYS */;
INSERT INTO `pessoaimg` (`idImg`, `idPessoa`, `img`) VALUES
	(1, 13, 'de409a98-16a0-4814-904e-d0eb72f6e1ebpp2-img1.jpg'),
	(2, 16, '8cad71b8-21ff-4beb-9b1e-3d5e97f830f7Penguins.jpg');
/*!40000 ALTER TABLE `pessoaimg` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.pessoajuridica
DROP TABLE IF EXISTS `pessoajuridica`;
CREATE TABLE IF NOT EXISTS `pessoajuridica` (
  `idPessoaJuridica` int(10) NOT NULL,
  `cnpj` char(14) default NULL,
  `ie` varchar(20) default NULL,
  `dtFundacao` date default NULL,
  `flagImobiliaria` enum('S','N') default 'S',
  `creci` varchar(10) default NULL,
  PRIMARY KEY  (`idPessoaJuridica`),
  UNIQUE KEY `cnpj` (`cnpj`),
  CONSTRAINT `FK_PessoaJuridica_Pessoa` FOREIGN KEY (`idPessoaJuridica`) REFERENCES `pessoa` (`idPessoa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table dbopcaoimovel.pessoajuridica: ~3 rows (approximately)
/*!40000 ALTER TABLE `pessoajuridica` DISABLE KEYS */;
INSERT INTO `pessoajuridica` (`idPessoaJuridica`, `cnpj`, `ie`, `dtFundacao`, `flagImobiliaria`, `creci`) VALUES
	(13, '23243434343434', '4345', '2012-08-15', 'S', '43545'),
	(16, '23232132132132', '', '2012-10-02', 'S', ''),
	(20, '12321321321321', '', '2012-09-24', 'S', '');
/*!40000 ALTER TABLE `pessoajuridica` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.pessoaplano
...
-- Dumping data for table dbopcaoimovel.pessoaplano: ~0 rows (approximately)
/*!40000 ALTER TABLE `pessoaplano` DISABLE KEYS */;
/*!40000 ALTER TABLE `pessoaplano` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.plano
...
-- Dumping data for table dbopcaoimovel.plano: ~0 rows (approximately)
/*!40000 ALTER TABLE `plano` DISABLE KEYS */;
/*!40000 ALTER TABLE `plano` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.planocategoria
DROP TABLE IF EXISTS `planocategoria`;
CREATE TABLE IF NOT EXISTS `planocategoria` (
  `idCategoria` int(10) NOT NULL auto_increment,
  `descricao` varchar(50) NOT NULL COMMENT 'os planos podem ser simples,medio,alto,ilimitado',
  PRIMARY KEY  (`idCategoria`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table dbopcaoimovel.planocategoria: ~0 rows (approximately)
/*!40000 ALTER TABLE `planocategoria` DISABLE KEYS */;
/*!40000 ALTER TABLE `planocategoria` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.roles
...
-- Dumping data for table dbopcaoimovel.roles: ~2 rows (approximately)
...
-- Dumping structure for table dbopcaoimovel.servico
...
-- Dumping data for table dbopcaoimovel.servico: ~0 rows (approximately)
/*!40000 ALTER TABLE `servico` DISABLE KEYS */;
/*!40000 ALTER TABLE `servico` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.servicogrupo
...
-- Dumping data for table dbopcaoimovel.servicogrupo: ~0 rows (approximately)
/*!40000 ALTER TABLE `servicogrupo` DISABLE KEYS */;
/*!40000 ALTER TABLE `servicogrupo` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.siteparceiro
...
CREATE TABLE IF NOT EXISTS `siteparceiro` (
  ...
  `bloqueado` enum('S','N') NOT NULL default 'N',
...
-- Dumping data for table dbopcaoimovel.siteparceiro: ~0 rows (approximately)
/*!40000 ALTER TABLE `siteparceiro` DISABLE KEYS */;
/*!40000 ALTER TABLE `siteparceiro` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.sitepublicidade
...
-- Dumping data for table dbopcaoimovel.sitepublicidade: ~0 rows (approximately)
/*!40000 ALTER TABLE `sitepublicidade` DISABLE KEYS */;
/*!40000 ALTER TABLE `sitepublicidade` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.sitepublicidadebanner
...
-- Dumping structure for table dbopcaoimovel.tipolog
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='nesta tabela será cadastrado os tipos de log.';

-- Dumping data for table dbopcaoimovel.tipolog: ~6 rows (approximately)
...
-- Dumping structure for table dbopcaoimovel.usersinroles
...
-- Dumping data for table dbopcaoimovel.usersinroles: ~5 rows (approximately)
...
-- Dumping structure for table dbopcaoimovel.usuario
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `logado` enum('S','N') NOT NULL default 'N',
  `bloqueado` enum('S','N') NOT NULL default 'N',
...
-- Dumping data for table dbopcaoimovel.usuario: ~4 rows (approximately)
/*!40000 ALTER TABLE `usuario` DISABLE KEYS */;
INSERT INTO `usuario` (`idUsuario`, `idPessoa`, `idPapel`, `login`, `senha`, `logado`, `bloqueado`) VALUES
	(1, 1, 1, 'admin', '202cb962ac59075b964b07152d234b70', 'N', 'N'),
	(2, 13, 2, 'imob', '202cb962ac59075b964b07152d234b70', 'N', 'N'),
	(3, 16, 2, 'padraoimoveis', '202cb962ac59075b964b07152d234b70', 'N', 'N'),
	(4, 20, 2, 'abreu', '202cb962ac59075b964b07152d234b70', 'N', 'N');
/*!40000 ALTER TABLE `usuario` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.usuariolog
...
-- Dumping data for table dbopcaoimovel.usuariolog: ~0 rows (approximately)
/*!40000 ALTER TABLE `usuariolog` DISABLE KEYS */;
/*!40000 ALTER TABLE `usuariolog` ENABLE KEYS */;


-- Dumping structure for table dbopcaoimovel.usuariopapel
DROP TABLE IF EXISTS `usuariopapel`;
CREATE TABLE IF NOT EXISTS `usuariopapel` (
  `idPapel` int(10) NOT NULL auto_increment,
  `papel` varchar(20) NOT NULL default '0',
  PRIMARY KEY  (`idPapel`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

-- Dumping data for table dbopcaoimovel.usuariopapel: ~4 rows (approximately)
...
-- Dumping structure for table dbopcaoimovel.usuariopermissao
...
CREATE TABLE IF NOT EXISTS `usuariopermissao` (
  ...
  `idPapel` int(10) NOT NULL,
  `permissao` varchar(1000) NOT NULL,
  `permitir` enum('S','N') NOT NULL default 'N',
  PRIMARY KEY  (`idPermissao`),
  KEY `FK_Permissao_Papel` (`idPapel`),
  CONSTRAINT `FK_Permissao_Papel` FOREIGN KEY (`idPapel`) REFERENCES `usuariopapel` (`idPapel`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table dbopcaoimovel.usuariopermissao: ~0 rows (approximately)
