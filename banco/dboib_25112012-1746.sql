...
-- Dumping data for table dbopcaoimovel.anuncio: ~2 rows (approximately)
...
-- Dumping data for table dbopcaoimovel.endcidade: ~5.258 rows (approximately)
...
INSERT INTO `usuario` (`idUsuario`, `idPessoa`, `idPapel`, `login`, `senha`, `logado`, `bloqueado`, `acessos`, `ultimoAcesso`) VALUES
	(1, 1, 1, 'admin', '202cb962ac59075b964b07152d234b70', 'N', 'N', 4, '2012-11-25 16:57:09');
