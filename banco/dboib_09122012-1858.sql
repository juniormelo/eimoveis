...
-- Dumping data for table dbopcaoimovel.anuncio: ~1 rows (approximately)
...
INSERT INTO `anuncio` (`idAnuncio`, `idImovel`, `idTipo`, `codigo`, `valor`, `qtdVisita`, `dataIni`, `dataFim`, `status`, `motivoStatus`, `posicao`, `exibirMapa`, `titulo`, `descricao`, `telefone1`, `telefone2`, `email`, `responsavel`, `idUsuarioCad`, `dataCadastro`, `idUsuarioAlt`, `dataAlteracao`) VALUES
	(1, 3, 1, '123a', 10.00, 0, NULL, NULL, 'I', NULL, 'N', 'N', 'Casa em JandaÃ­ra', 'bla bla bla....', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'teste', NULL, NULL, 1, '2012-12-09 18:46:51');
...
-- Dumping data for table dbopcaoimovel.endcidade: ~5,841 rows (approximately)
...
-- Dumping data for table dbopcaoimovel.imovel: ~3 rows (approximately)
...
INSERT INTO `imovel` (`idImovel`, `codigo`, `idCategoria`, `idPessoaProprietario`, `idProprietarioImovel`, `descricao`, `area`, `cep`, `logradouro`, `numLogradouro`, `complemento`, `pontoReferencia`, `cidade`, `uf`, `bairro`, `pais`, `excluido`, `observacao`, `dataCadastro`) VALUES
	...
	(3, '123', 5, 1, 4, 'Casa em JandaÃ­ra', 56, '59151610', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de referencia', 'Parnamirim', 'RN', 'Nova Parnamirim', 'Brasil', 'N', 'observaÃ§Ãµes da casa', '2012-11-25 14:26:52');
...
) ENGINE=InnoDB AUTO_INCREMENT=79 DEFAULT CHARSET=utf8 COMMENT='associa uma determinada caracteristica a um imovel';

-- Dumping data for table dbopcaoimovel.imovelcaracteristica: ~18 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='cadastrar todos os tipos de caracteristica possiveis';
...
-- Dumping data for table dbopcaoimovel.imovelfoto: ~1 rows (approximately)
/*!40000 ALTER TABLE `imovelfoto` DISABLE KEYS */;
INSERT INTO `imovelfoto` (`idFoto`, `idImovel`, `ordem`, `descricao`, `foto`) VALUES
	(1, 1, 1, 'frente', '1_1d0646c6af44d54f380c800b5a687213.jpg');
...
-- Dumping data for table dbopcaoimovel.pessoa: ~4 rows (approximately)
...
INSERT INTO `pessoa` (`idPessoa`, `idPessoaProprietario`, `tipo`, `razao`, `fantasia`, `cpf_cnpj`, `rg_ie`, `dtNascimento`, `idEstadoCivil`, `flagCliente`, `flagCorretor`, `flagImobiliaria`, `creci`, `genero`, `dtCadastro`, `dtUltimaAlteracao`, `cep`, `logradouro`, `numLogradouro`, `complemento`, `pontoReferencia`, `bairro`, `cidade`, `uf`, `pais`, `observacao`, `visivel`, `telefone`, `fax`, `celular`, `email`, `site`) VALUES
	(1, 1, 'F', 'Administrador do Sistema', 'admin', '05414577480', NULL, '2010-01-01', NULL, 'S', 'N', 'N', NULL, 'M', '0000-00-00 00:00:00', '2012-11-25 15:13:42', NULL, '1', 's/n', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '(84) 3553-0026', NULL, '(84) 8715-2472', 'juniormelo85@gmail.com', NULL),
	(4, 1, 'F', 'Jose Selmo de Melo Junior', 'Junior Melo', '05414577480', '002267087', '1985-12-05', 2, 'N', 'N', 'N', NULL, 'M', NULL, NULL, '59151610', 'Avenida Ayrton Senna', '123', 'comp', 're', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ãµe', 0, '(84) 3553-0026', '(84) 3553-0026', '(84) 9126-5130', 'junior_melo85@hotmail.com', 'www'),
	(5, 1, 'F', 'Sylvia Roberta da Silva Melo', 'Sylvia a FOFA', '16734962610', '002267087', '1984-08-15', 2, 'S', 'N', 'N', NULL, 'F', NULL, NULL, '59151610', 'Avenida Ayrton Senna', '123', 'comp', 're', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ãµes', 0, '(84) 3553-0026', '(84) 3553-0026', '(84) 9126-5130', 'junior_melo85@hotmail.com', 'www'),
	(6, 1, 'F', 'Sylvia Roberta da Silva Melo', 'Fofa', '64259117190', '0000', '1984-08-15', 2, 'N', 'N', 'N', NULL, 'F', NULL, NULL, '59594000', 'av aristofanes fernandes', '527', 'complemento', 'referencia', 'Centro', 'JandaÃ­ra', 'RN', 'Brasil', 'outras informaÃ§Ãµes', 0, '(00) 0000-0000', '(00) 0000-0000', '(00) 0000-0000', 'sylvia@hotmail.com', 'site');
...
INSERT INTO `usuario` (`idUsuario`, `idPessoa`, `idPapel`, `login`, `senha`, `logado`, `bloqueado`, `acessos`, `ultimoAcesso`) VALUES
	(1, 1, 1, 'admin', 'eb0a191797624dd3a48fa681d3061212', 'N', 'N', 53, '2012-12-09 18:55:59'),
	(8, 6, 3, 'sylvia', '202cb962ac59075b964b07152d234b70', 'N', 'N', 2, '2012-12-09 18:29:10'),
	(23, 4, 2, 'adm', '202cb962ac59075b964b07152d234b70', 'N', 'N', 6, '2012-12-09 18:29:10');
