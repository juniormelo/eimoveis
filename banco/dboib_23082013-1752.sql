...
INSERT INTO `anuncio` (`idAnuncio`, `idImovel`, `idTipo`, `codigo`, `valor`, `qtdVisita`, `dataIni`, `dataFim`, `status`, `motivoStatus`, `posicao`, `exibirMapa`, `titulo`, `descricao`, `telefone1`, `telefone2`, `email`, `responsavel`, `idUsuarioCad`, `dataCadastro`, `idUsuarioAlt`, `dataAlteracao`) VALUES
	(1, 3, 5, '123a', 80000.00, 103, NULL, NULL, 'A', NULL, 'N', 'N', 'Casa em JandaÃ­ra', 'bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'teste', NULL, '2013-08-05 21:41:09', 1, '2013-08-23 17:32:01'),
	(3, 1, 1, '244534', 456.00, 157, NULL, NULL, 'A', NULL, 'D', 'S', 'Apartamento Alameda dos Eucaliptos', 'sfgsgsdfgsdf', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'Administrador do Sistema', NULL, '2013-08-05 21:41:09', 1, '2013-08-23 17:19:47'),
	(4, 5, 5, '6756', 80000.00, 137, NULL, NULL, 'A', NULL, 'D', 'S', 'Casa em pedro velho', 'asdfadsf', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'JosÃ© Selmo de Melo Junior', NULL, '2013-08-05 21:41:09', 1, '2013-08-23 17:32:07'),
	...
	(9, 4, 1, 'xxxx123abc', 761.00, 56, NULL, NULL, 'A', NULL, 'N', 'N', 'Sala da Mr Chip', 'Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal kasjgÃ§klasdfg.', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'JÃºnior Melo', 1, '2013-08-05 22:06:47', 1, '2013-08-23 17:31:53'),
	(11, 7, 1, '000012', 1200.00, 82, NULL, NULL, 'A', NULL, 'D', 'N', 'Casa da teste imobiliaria', 'bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla .', '(22) 2222-2222', '(22) 2222-2222', 'imobiliaria@imobiliariapadrao.com.br', 'Imobiliaria PadrÃ£o', 55, '2013-08-06 20:45:25', 55, '2013-08-23 17:29:07');
...
# Dumping data for table atriu820_junior.anunciocontato: ~0 rows (approximately)
...
# Dumping data for table atriu820_junior.endcidade: ~5.395 rows (approximately)
...
INSERT INTO `imovel` (`idImovel`, `codigo`, `idCategoria`, `idPessoaProprietario`, `idProprietarioImovel`, `descricao`, `area`, `cep`, `logradouro`, `numLogradouro`, `complemento`, `pontoReferencia`, `cidade`, `uf`, `bairro`, `pais`, `excluido`, `observacao`, `dataCadastro`) VALUES
	...
	(7, '88383883', 5, 56, 56, 'Casa da teste imobiliaria', 200, '59151510', 'Rua AntÃ´nio CÃ­cero', '123', 'complemento', 'referencia', 'Parnamirim', 'RN', 'Nova Parnamirim', 'Brasil', 'N', 'bla bla bla.', '2013-08-06 20:42:48');
...
) ENGINE=InnoDB AUTO_INCREMENT=780 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='associa uma determinada caracteristica a um imovel';
...
INSERT INTO `imovelfoto` (`idFoto`, `idImovel`, `ordem`, `descricao`, `foto`) VALUES
	...
	(93, 7, 2, 'Imagem da frente do imovel', '7_e73b2e47ff6ba5b3c79eb2c3a4c43a33.jpg'),
	(94, 7, 1, 'Sala', '7_fe604587f84ebdae74c87aaddcc842ca.jpg'),
...
CREATE TABLE IF NOT EXISTS `imovelsolicitado` (
  ...
  `celular` char(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `email` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
# Dumping data for table atriu820_junior.sitevisita: 56 rows
...
INSERT INTO `usuario` (`idUsuario`, `idPessoa`, `idPapel`, `login`, `senha`, `logado`, `bloqueado`, `acessos`, `ultimoAcesso`) VALUES
	(1, 1, 1, 'admin', 'eb0a191797624dd3a48fa681d3061212', 'N', 'N', 161, '2013-08-22 21:40:28'),
	(23, 4, 2, 'junior', '202cb962ac59075b964b07152d234b70', 'N', 'N', 9, '2013-04-28 22:05:03'),
	(55, 56, 2, 'imobiliariapadrao', '202cb962ac59075b964b07152d234b70', 'N', 'N', 8, '2013-08-22 11:54:12'),
