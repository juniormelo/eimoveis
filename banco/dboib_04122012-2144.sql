...
-- Dumping data for table dbopcaoimovel.funcionario: ~1 rows (approximately)
...
INSERT INTO `funcionario` (`idFuncionario`, `idCargo`, `carteiraTrab`, `dtAdmissao`, `dtDemissao`, `motivoDemissao`, `salario`, `pis_pasep`, `cnh`, `dtCadastro`, `observacao`) VALUES
	(4, 1, '', NULL, NULL, NULL, NULL, '', '', '2012-12-01 18:56:45', NULL);
...
-- Dumping data for table dbopcaoimovel.pessoa: ~3 rows (approximately)
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_gravar_usuario`(`pIdUsuario` INT, `pIdPessoa` INT, `pIdPapel` INT, `pLogin` VARCHAR(20), `pSenha` VARCHAR(50))
BEGIN
	IF EXISTS(SELECT idusuario FROM usuario WHERE idUsuario=pIdUsuario) THEN
		IF EXISTS(SELECT idusuario FROM usuario WHERE idUsuario=pIdUsuario AND login=pLogin) THEN
			IF (trim(pSenha) <> '') THEN
		...
		ELSE
			SELECT 'ID' AS RESULT FROM usuario limit 1;
		END IF;
   ELSE
...
-- Dumping data for table dbopcaoimovel.usuario: ~2 rows (approximately)
/*!40000 ALTER TABLE `usuario` DISABLE KEYS */;
INSERT INTO `usuario` (`idUsuario`, `idPessoa`, `idPapel`, `login`, `senha`, `logado`, `bloqueado`, `acessos`, `ultimoAcesso`) VALUES
	(1, 1, 1, 'admin', '202cb962ac59075b964b07152d234b70', 'N', 'N', 35, '2012-12-04 20:02:00'),
	(5, 4, 3, 'corretor', '202cb962ac59075b964b07152d234b70', 'N', 'N', 3, '2012-12-02 18:36:26');
