...
INSERT INTO `anuncio` (`idAnuncio`, `idImovel`, `idTipo`, `codigo`, `valor`, `qtdVisita`, `dataIni`, `dataFim`, `status`, `motivoStatus`, `posicao`, `exibirMapa`, `titulo`, `descricao`, `telefone1`, `telefone2`, `email`, `responsavel`, `idUsuarioCad`, `dataCadastro`, `idUsuarioAlt`, `dataAlteracao`) VALUES
	(1, 3, 1, '123a', 10.00, 0, NULL, NULL, 'A', NULL, 'N', 'N', 'Casa em JandaÃ­ra', 'bla bla bla....', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'teste', NULL, NULL, 1, '2012-11-28 21:58:28');
...
-- Dumping data for table dbopcaoimovel.endcidade: ~5,837 rows (approximately)
...
-- Dumping data for table dbopcaoimovel.estadocivil: ~5 rows (approximately)
...
INSERT INTO `pessoa` (`idPessoa`, `idPessoaProprietario`, `tipo`, `razao`, `fantasia`, `cpf_cnpj`, `rg_ie`, `dtNascimento`, `idEstadoCivil`, `flagCliente`, `flagCorretor`, `flagImobiliaria`, `creci`, `genero`, `dtCadastro`, `dtUltimaAlteracao`, `cep`, `logradouro`, `numLogradouro`, `complemento`, `pontoReferencia`, `bairro`, `cidade`, `uf`, `pais`, `observacao`, `visivel`, `telefone`, `fax`, `celular`, `email`, `site`) VALUES
	...
	(6, 1, 'F', 'Sylvia Roberta da Silva Melo', 'Fofa', '64259117190', '0000', '1984-08-15', 2, 'N', 'N', 'N', NULL, 'F', NULL, NULL, '59594000', 'av aristofanes fernandes', '527', 'complemento', 'referencia', 'Centro', 'JandaÃ­ra', 'RN', 'Brasil', 'outras informaÃ§Ãµes', 0, '(00) 0000-0000', '(00) 0000-0000', '(00) 0000-0000', 'junior_melo85@hotmail.com', 'site');
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_gravar_usuario`(IN `pIdUsuario` INT, IN `pIdPessoa` INT, IN `pIdPapel` INT, IN `pLogin` VARCHAR(20), IN `pSenha` VARCHAR(50))
BEGIN
	IF EXISTS(SELECT idusuario FROM usuario WHERE idUsuario=pIdUsuario) THEN
		IF (trim(pSenha) <> '') THEN
			UPDATE usuario SET idPapel=pIdPapel,senha=md5(pSenha) WHERE idUsuario=pIdUsuario;			
		ELSE
			UPDATE usuario SET idPapel=pIdPapel WHERE idUsuario=pIdUsuario;	
		END IF;
   ...
   ELSE
   	...
   	IF EXISTS(SELECT idusuario FROM usuario WHERE login=pLogin) THEN
		...
		ELSE
			INSERT usuario (idPessoa,idPapel,login,senha,acessos) 
			VALUES (pIdPessoa,pIdPapel,pLogin,MD5(pSenha),0);
			SELECT 'OK' AS RESULT FROM usuario limit 1;
		END IF;
   END IF;
END//
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `ultimoAcesso` timestamp NULL default NULL on update CURRENT_TIMESTAMP,
...
INSERT INTO `usuario` (`idUsuario`, `idPessoa`, `idPapel`, `login`, `senha`, `logado`, `bloqueado`, `acessos`, `ultimoAcesso`) VALUES
	(1, 1, 1, 'admin', 'eb0a191797624dd3a48fa681d3061212', 'N', 'N', 45, '2012-12-07 19:33:10'),
	(8, 6, 2, 'sylvia', '202cb962ac59075b964b07152d234b70', 'N', 'N', 1, '2012-12-07 20:25:04'),
	(11, 4, 3, 'jose', '202cb962ac59075b964b07152d234b70', 'N', 'N', 0, NULL);
