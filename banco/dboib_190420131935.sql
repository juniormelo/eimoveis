...
-- Dumping data for table dbopcaoimovel.anuncio: ~5 rows (approximately)
...
INSERT INTO `anuncio` (`idAnuncio`, `idImovel`, `idTipo`, `codigo`, `valor`, `qtdVisita`, `dataIni`, `dataFim`, `status`, `motivoStatus`, `posicao`, `exibirMapa`, `titulo`, `descricao`, `telefone1`, `telefone2`, `email`, `responsavel`, `idUsuarioCad`, `dataCadastro`, `idUsuarioAlt`, `dataAlteracao`) VALUES
	(1, 3, 5, '123a', 80000.00, 0, NULL, NULL, 'A', NULL, 'D', 'N', 'Casa em JandaÃ­ra', 'bla bla bla....', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'teste', NULL, NULL, 1, '2013-04-14 00:04:39'),
	(2, 4, 1, '12355', 700.00, 0, NULL, NULL, 'A', NULL, 'D', 'N', 'Sala da Mr Chip', 'otima localizaÃ§Ã£o proximo a sanduicheria budega', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'Administrador do Sistema', NULL, NULL, 1, '2013-04-13 22:29:16'),
	(3, 1, 1, '244534', 456.00, 0, NULL, NULL, 'A', NULL, 'D', 'N', 'Apartamento Alameda dos Eucaliptos', 'sfgsgsdfgsdf', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'Administrador do Sistema', NULL, NULL, 1, '2013-04-14 10:55:15'),
	(4, 5, 5, '6756', 85000.00, 0, NULL, NULL, 'A', NULL, 'N', 'S', 'Casa em pedro velho', 'asdfadsf', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'Administrador do Sistema', NULL, NULL, 1, '2013-04-14 00:03:41'),
	(5, 6, 1, 'tytryrty', 564.00, 0, NULL, NULL, 'A', NULL, 'D', 'N', 'Casa vovo', 'dggsgsdf', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'Administrador do Sistema', NULL, NULL, 1, '2013-04-13 23:58:14');
...
-- Dumping data for table dbopcaoimovel.anuncioproposta: ~0 rows (approximately)
...
-- Dumping data for table dbopcaoimovel.anunciotipo: ~4 rows (approximately)
...
-- Dumping data for table dbopcaoimovel.cargo: ~4 rows (approximately)
...
-- Dumping data for table dbopcaoimovel.endcidade: ~5,689 rows (approximately)
...
INSERT INTO `funcionario` (`idFuncionario`, `idCargo`, `carteiraTrab`, `dtAdmissao`, `dtDemissao`, `motivoDemissao`, `salario`, `pis_pasep`, `cnh`, `dtCadastro`, `observacao`) VALUES
	...
	(6, 4, '111', '0101-01-20', NULL, NULL, NULL, '12112', '3498032948', '2012-12-06 21:07:39', NULL);
...
-- Dumping data for table dbopcaoimovel.imovel: ~6 rows (approximately)
...
INSERT INTO `imovel` (`idImovel`, `codigo`, `idCategoria`, `idPessoaProprietario`, `idProprietarioImovel`, `descricao`, `area`, `cep`, `logradouro`, `numLogradouro`, `complemento`, `pontoReferencia`, `cidade`, `uf`, `bairro`, `pais`, `excluido`, `observacao`, `dataCadastro`) VALUES
	(1, '123', 2, 1, 5, 'Apartamento Alameda dos Eucaliptos', 56, '59151610', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de referencia', 'Parnamirim', 'RN', 'Nova Parnamirim', 'Brasil', 'N', 'observaÃ§Ãµes do apartamento', '2012-11-19 20:31:27'),
...
) ENGINE=InnoDB AUTO_INCREMENT=126 DEFAULT CHARSET=utf8 COMMENT='associa uma determinada caracteristica a um imovel';

-- Dumping data for table dbopcaoimovel.imovelcaracteristica: ~21 rows (approximately)
...
-- Dumping data for table dbopcaoimovel.imovelcategoria: ~34 rows (approximately)
...
-- Dumping data for table dbopcaoimovel.imovelfoto: ~4 rows (approximately)
...
-- Dumping data for table dbopcaoimovel.pessoa: ~5 rows (approximately)
...
INSERT INTO `pessoa` (`idPessoa`, `idPessoaProprietario`, `tipo`, `razao`, `fantasia`, `cpf_cnpj`, `rg_ie`, `dtNascimento`, `idEstadoCivil`, `flagCliente`, `flagCorretor`, `flagImobiliaria`, `creci`, `genero`, `dtCadastro`, `dtUltimaAlteracao`, `cep`, `logradouro`, `numLogradouro`, `complemento`, `pontoReferencia`, `bairro`, `cidade`, `uf`, `pais`, `observacao`, `visivel`, `telefone`, `fax`, `celular`, `email`, `site`, `flagCredenciado`) VALUES
	...
	(5, 1, 'F', 'Sylvia Roberta da Silva Melo', 'Sylvia a FOFA', '16734962610', '002267087', '1984-08-15', 2, 'S', 'N', 'N', NULL, 'F', NULL, NULL, '59151610', 'Avenida Ayrton Senna', '123', 'comp', 're', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ãµes', 0, '(84) 3553-0026', '(84) 3553-0026', '(84) 9126-5130', 'junior_melo85@hotmail.com', 'www', 'N'),
	(6, 1, 'F', 'Sylvia Roberta da Silva Melo', 'Fofa', '64259117190', '0000', '1984-08-15', 2, 'N', 'N', 'N', NULL, 'F', NULL, NULL, '59594000', 'av aristofanes fernandes', '527', 'complemento', 'referencia', 'Centro', 'JandaÃ­ra', 'RN', 'Brasil', 'outras informaÃ§Ãµes', 0, '(00) 0000-0000', '(00) 0000-0000', '(00) 0000-0000', 'sylvia@hotmail.com', 'site', NULL),
	(7, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'N', 'N', 'N', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 'S');
...
-- Dumping data for table dbopcaoimovel.pessoaimg: ~0 rows (approximately)
...
-- Dumping structure for procedure dbopcaoimovel.sp_gravar_usuario
DROP PROCEDURE IF EXISTS `sp_gravar_usuario`;
DELIMITER //
-- CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_gravar_usuario`(IN `pIdUsuario` INT, IN `pIdPessoa` INT, IN `pIdPapel` INT, IN `pLogin` VARCHAR(20), IN `pSenha` VARCHAR(50), IN `pBloqueado` CHAR(1))
CREATE PROCEDURE `sp_gravar_usuario`(IN `pIdUsuario` INT, IN `pIdPessoa` INT, IN `pIdPapel` INT, IN `pLogin` VARCHAR(20), IN `pSenha` VARCHAR(50), IN `pBloqueado` CHAR(1))
BEGIN
...
-- Dumping data for table dbopcaoimovel.usuario: ~3 rows (approximately)
/*!40000 ALTER TABLE `usuario` DISABLE KEYS */;
INSERT INTO `usuario` (`idUsuario`, `idPessoa`, `idPapel`, `login`, `senha`, `logado`, `bloqueado`, `acessos`, `ultimoAcesso`) VALUES
	(1, 1, 1, 'admin', 'eb0a191797624dd3a48fa681d3061212', 'N', 'N', 68, '2013-04-14 10:54:41'),
	(8, 6, 3, 'sylvia', '202cb962ac59075b964b07152d234b70', 'N', 'N', 2, '2012-12-09 18:29:10'),
	(23, 4, 2, 'adm', '202cb962ac59075b964b07152d234b70', 'N', 'N', 7, '2013-01-11 19:14:29');
