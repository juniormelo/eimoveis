...
-- Copiando dados para a tabela eimoveis_db.banco: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela eimoveis_db.contabanco: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela eimoveis_db.contareceber: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela eimoveis_db.endcidade: ~5.507 rows (aproximadamente)
...
-- Copiando dados para a tabela eimoveis_db.planodeconta: ~380 rows (aproximadamente)
...
INSERT INTO `usuario` (`idUsuario`, `idPessoa`, `idPapel`, `login`, `senha`, `logado`, `bloqueado`, `acessos`, `ultimoAcesso`) VALUES
	(1, 1, 1, 'admin', 'eb0a191797624dd3a48fa681d3061212', 'N', 'N', 400, '2014-11-02 21:41:29'),
