...
INSERT INTO `anuncio` (`idAnuncio`, `idImovel`, `idTipo`, `codigo`, `valor`, `qtdVisita`, `dataIni`, `dataFim`, `status`, `motivoStatus`, `posicao`, `exibirMapa`, `titulo`, `descricao`, `telefone1`, `telefone2`, `email`, `responsavel`, `idUsuarioCad`, `dataCadastro`, `idUsuarioAlt`, `dataAlteracao`) VALUES
	...
	(3, 1, 1, '244534', 456.00, 72, NULL, NULL, 'A', NULL, 'D', 'N', 'Apartamento Alameda dos Eucaliptos', 'sfgsgsdfgsdf', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'Administrador do Sistema', NULL, '2013-08-05 21:41:09', 1, '2013-08-06 14:35:37'),
	...
	(5, 6, 1, 'tytryrty', 600.00, 42, NULL, NULL, 'A', NULL, 'D', 'N', 'Casa vovo', 'dggsgsdf', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'Administrador do Sistema', NULL, '2013-08-05 21:41:09', 1, '2013-08-06 14:32:46'),
...
-- Dumping data for table divmaste_oib.endcidade: ~5,702 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=194 DEFAULT CHARSET=utf8 COMMENT='associa uma determinada caracteristica a um imovel';
...
INSERT INTO `pessoa` (`idPessoa`, `idPessoaProprietario`, `tipo`, `razao`, `fantasia`, `cpf_cnpj`, `rg_ie`, `dtNascimento`, `idEstadoCivil`, `flagCliente`, `flagCorretor`, `flagImobiliaria`, `creci`, `genero`, `dtCadastro`, `dtUltimaAlteracao`, `cep`, `logradouro`, `numLogradouro`, `complemento`, `pontoReferencia`, `bairro`, `cidade`, `uf`, `pais`, `observacao`, `visivel`, `telefone`, `fax`, `celular`, `email`, `site`, `flagCredenciado`) VALUES
	...
	(8, 8, 'F', 'Imobiliaria PadrÃ£o', 'Imobiliaria PadrÃ£o', '48380668000138', '123000', '2001-01-01', 2, 'N', 'N', 'N', NULL, 'F', NULL, '2013-04-28 22:36:18', '59151610', 'Avenida Ayrton Senna', '123', 'complemento', 'ponto de referencia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'imobiliaria de teste', 0, '(11) 1111-1111', '(11) 1111-1111', '(11) 1111-1111', 'imobiliariapadrao@hotmail.com', 'www.imobiliariapadrao.com.br', 'S'),
	(15, 15, 'J', 'Imobiliaria teste 2', 'Imobiliaria teste 2', '81621938000120', '0002', '1985-12-05', 2, 'N', 'N', 'S', NULL, 'M', NULL, NULL, '59594000', 'Avenida Miguel Castro', '123', 'complemento', 'ref', 'Centro', 'JandaÃ­ra', 'RN', 'Brasil', 'adsfsdfds', 0, '111111', '1111', '(88) 8888-8888', 'junior_melo85@hotmail.com', 'meu site', 'S'),
...
INSERT INTO `usuario` (`idUsuario`, `idPessoa`, `idPapel`, `login`, `senha`, `logado`, `bloqueado`, `acessos`, `ultimoAcesso`) VALUES
	(1, 1, 1, 'admin', 'eb0a191797624dd3a48fa681d3061212', 'N', 'N', 132, '2013-08-06 14:47:29'),
	...
	(24, 8, 2, 'adm', '202cb962ac59075b964b07152d234b70', 'N', 'N', 4, '2013-04-28 22:44:04'),
	(26, 15, 2, 'adm_imo', '202cb962ac59075b964b07152d234b70', 'N', 'N', 1, '2013-04-28 22:37:51');
