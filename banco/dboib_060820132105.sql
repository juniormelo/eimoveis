...
-- Dumping data for table divmaste_oib.anuncio: ~5 rows (approximately)
...
INSERT INTO `anuncio` (`idAnuncio`, `idImovel`, `idTipo`, `codigo`, `valor`, `qtdVisita`, `dataIni`, `dataFim`, `status`, `motivoStatus`, `posicao`, `exibirMapa`, `titulo`, `descricao`, `telefone1`, `telefone2`, `email`, `responsavel`, `idUsuarioCad`, `dataCadastro`, `idUsuarioAlt`, `dataAlteracao`) VALUES
	(1, 3, 5, '123a', 80000.00, 41, NULL, NULL, 'A', NULL, 'N', 'N', 'Casa em JandaÃ­ra', 'bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'teste', NULL, '2013-08-05 21:41:09', 1, '2013-08-06 14:46:07'),
	(3, 1, 1, '244534', 456.00, 73, NULL, NULL, 'A', NULL, 'D', 'N', 'Apartamento Alameda dos Eucaliptos', 'sfgsgsdfgsdf', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'Administrador do Sistema', NULL, '2013-08-05 21:41:09', 1, '2013-08-06 20:55:07'),
	(4, 5, 5, '6756', 80000.00, 56, NULL, NULL, 'A', NULL, 'D', 'S', 'Casa em pedro velho', 'asdfadsf', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'JosÃ© Selmo de Melo Junior', NULL, '2013-08-05 21:41:09', 1, '2013-08-06 14:47:18'),
	(5, 6, 1, 'tytryrty', 600.00, 43, NULL, NULL, 'A', NULL, 'D', 'N', 'Casa vovo', 'dggsgsdf', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'Administrador do Sistema', NULL, '2013-08-05 21:41:09', 1, '2013-08-06 20:26:55'),
	(9, 4, 1, 'xxxx123abc', 761.00, 12, NULL, NULL, 'A', NULL, 'N', 'N', 'Sala da Mr Chip', 'Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal Otima localizaÃ§Ã£o tal e tal kasjgÃ§klasdfg.', '(84) 3553-0026', '(84) 8715-2472', 'juniormelo85@gmail.com', 'JÃºnior Melo', 1, '2013-08-05 22:06:47', 1, '2013-08-05 23:16:15'),
	(11, 7, 1, '000012', 1200.00, 9, NULL, NULL, 'A', NULL, 'D', 'N', 'Casa da teste imobiliaria', 'bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla .', '(22) 2222-2222', '(22) 2222-2222', 'imobiliaria@imobiliariapadrao.com.br', 'Imobiliaria PadrÃ£o', 55, '2013-08-06 20:45:25', 55, '2013-08-06 21:02:46');
...
-- Dumping data for table divmaste_oib.imovel: ~6 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=204 DEFAULT CHARSET=utf8 COMMENT='associa uma determinada caracteristica a um imovel';

-- Dumping data for table divmaste_oib.imovelcaracteristica: ~21 rows (approximately)
...
-- Dumping data for table divmaste_oib.imovelfoto: ~7 rows (approximately)
/*!40000 ALTER TABLE `imovelfoto` DISABLE KEYS */;
INSERT INTO `imovelfoto` (`idFoto`, `idImovel`, `ordem`, `descricao`, `foto`) VALUES
	(4, 1, 1, '', '1_bf540aaa4d8c68df1113e4b7bd10a0a3.jpg'),
	(5, 3, 1, '', '3_438a3c4da973f496adb23e19388c8fc5.jpg'),
	...
	(9, 1, 2, NULL, '3_438a3c4da973f496adb23e19388c8fc5.jpg'),
	(10, 1, 1, 'Decorado', '1_a49a4e8778859770b13536fb4f3887ad.jpg'),
...
-- Dumping data for table divmaste_oib.imovelproximidade: ~6 rows (approximately)
...
-- Dumping data for table divmaste_oib.pessoa: ~8 rows (approximately)
/*!40000 ALTER TABLE `pessoa` DISABLE KEYS */;
INSERT INTO `pessoa` (`idPessoa`, `idPessoaProprietario`, `tipo`, `razao`, `fantasia`, `cpf_cnpj`, `rg_ie`, `dtNascimento`, `idEstadoCivil`, `flagCliente`, `flagCorretor`, `flagImobiliaria`, `creci`, `genero`, `dtCadastro`, `dtUltimaAlteracao`, `cep`, `logradouro`, `numLogradouro`, `complemento`, `pontoReferencia`, `bairro`, `cidade`, `uf`, `pais`, `observacao`, `visivel`, `telefone`, `fax`, `celular`, `email`, `site`, `flagCredenciado`) VALUES
	(1, 1, 'F', 'Administrador do Sistema', 'admin', '05414577480', NULL, '2010-01-01', NULL, 'S', 'N', 'N', NULL, 'M', '0000-00-00 00:00:00', '2012-11-25 15:13:42', NULL, '1', 's/n', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '(84) 3553-0026', NULL, '(84) 8715-2472', 'juniormelo85@gmail.com', NULL, NULL),
	(4, 1, 'F', 'Jose Selmo de Melo Junior', 'Junior Melo', '05414577480', '002267087', '1985-12-05', 2, 'S', 'N', 'N', NULL, 'M', NULL, NULL, '59151610', 'Avenida Ayrton Senna', '123', 'comp', 're', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ãµe', 0, '(84) 3553-0026', '(84) 3553-0026', '(84) 9126-5130', 'junior_melo85@hotmail.com', 'www', 'N'),
	(5, 1, 'F', 'Sylvia Roberta da Silva Melo', 'Sylvia a FOFA', '16734962610', '002267087', '1984-08-15', 2, 'S', 'N', 'N', NULL, 'F', NULL, NULL, '59151610', 'Avenida Ayrton Senna', '123', 'comp', 're', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ãµes', 0, '(84) 3553-0026', '(84) 3553-0026', '(84) 9126-5130', 'sylvia@hotmail.com', 'www', 'N'),
	(6, 1, 'F', 'Sylvia Roberta da Silva Melo', 'Fofa', '64259117190', '0000', '1984-08-15', 2, 'N', 'N', 'N', NULL, 'F', NULL, NULL, '59594000', 'av aristofanes fernandes_', '527', 'complemento', 'referencia', 'Centro', 'JandaÃ­ra', 'RN', 'Brasil', 'outras informaÃ§Ãµes', 0, '(00) 0000-0000', '(00) 0000-0000', '(00) 0000-0000', 'sylvia@hotmail.com', 'site', 'N'),
	(16, 8, 'F', 'Jose Selmo de Melo Junior', 'Junior Melo', '05414577480', '002267087', '1985-12-05', 2, 'S', 'N', 'N', NULL, 'M', NULL, NULL, '59151610', 'Avenida Ayrton Senna', '123', 'comp', 're', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'observaÃ§Ãµe', 0, '(84) 3553-0026', '(84) 3553-0026', '(84) 9126-5130', 'junior_melo85@hotmail.com', 'www', 'N'),
	(56, 56, 'J', 'Imobiliaria PadrÃ£o', 'Imobiliaria PadrÃ£o', '27336076000149', '00000', '2010-01-01', 2, 'N', 'N', 'N', NULL, 'M', NULL, NULL, '59151610', 'Avenida Ayrton Senna', '123', 'complemento', 'referÃªncia', 'Nova Parnamirim', 'Parnamirim', 'RN', 'Brasil', 'testando o cadastro da imobiliaria padrÃ£o com o usuario.', 0, '(22) 2222-2222', '(22) 2222-2222', '(22) 2222-2222', 'imobiliaria@imobiliariapadrao.com.br', 'www.imobiliariapadrao.com.br', 'S');
...
-- Dumping data for table divmaste_oib.usuario: ~5 rows (approximately)
/*!40000 ALTER TABLE `usuario` DISABLE KEYS */;
INSERT INTO `usuario` (`idUsuario`, `idPessoa`, `idPapel`, `login`, `senha`, `logado`, `bloqueado`, `acessos`, `ultimoAcesso`) VALUES
	(1, 1, 1, 'admin', 'eb0a191797624dd3a48fa681d3061212', 'N', 'N', 136, '2013-08-06 21:01:22'),
	...
	(55, 56, 2, 'imobiliariapadrao', '202cb962ac59075b964b07152d234b70', 'N', 'N', 2, '2013-08-06 20:32:23');
