...
-- Dumping data for table dbopcaoimovel.endcidade: ~5,387 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `imovel` (
  ...
  `idProprietarioImovel` int(10) NOT NULL,
  ...
  CONSTRAINT `FK_Proprietario` FOREIGN KEY (`idProprietario`) REFERENCES `pessoa` (`idPessoa`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- Dumping data for table dbopcaoimovel.imovel: ~2 rows (approximately)
/*!40000 ALTER TABLE `imovel` DISABLE KEYS */;
INSERT INTO `imovel` (`idImovel`, `idCategoria`, `idProprietario`, `idProprietarioImovel`, `descricao`, `area`, `cep`, `logradouro`, `numLogradouro`, `complemento`, `pontoReferencia`, `bairro`, `cidade`, `uf`, `pais`, `excluido`, `observacao`, `dataCadastro`) VALUES
...
CREATE TABLE IF NOT EXISTS `imovelcaracteristica` (
  ...
  `obsCaracteristica` varchar(100) default '0' COMMENT 'exemplo: quarto 3, banheiro 2',
  `idImovel` int(10) NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='associa uma determinada caracteristica a um imovel';

-- Dumping data for table dbopcaoimovel.imovelcaracteristica: ~11 rows (approximately)
/*!40000 ALTER TABLE `imovelcaracteristica` DISABLE KEYS */;
INSERT INTO `imovelcaracteristica` (`idImovelCaracteristica`, `idCaracteristica`, `obsCaracteristica`, `idImovel`) VALUES
	(1, 3, 'Info Campo', 1),
	(2, 5, 'Info Horta', 1),
	(3, 2, 'Info Lago', 1),
	(4, 16, 'Info sala', 1),
	(5, 18, '&nbsp', 2),
	(6, 12, '3, sendo 1 lavabo', 2),
	(7, 4, '&nbsp', 2),
	(8, 8, 'R$ 150,00', 2),
	(9, 15, '&nbsp', 2),
	(10, 9, '4, sendo 1 suíte', 2),
	(11, 16, '&nbsp', 2);
...
-- Dumping data for table dbopcaoimovel.imovelfoto: ~9 rows (approximately)
/*!40000 ALTER TABLE `imovelfoto` DISABLE KEYS */;
INSERT INTO `imovelfoto` (`idFoto`, `idImovel`, `foto`, `isprincipal`) VALUES
	(1, 1, 'b160ab9e-6ca8-4574-b868-fe07ad9f0017pp-img6.jpg', 0),
	(2, 1, '4524a55a-32e3-45f0-869d-9f4ab42a8377Desert.jpg', 0),
	(3, 1, '60399f5b-1d0d-445b-9cfc-2926faf381e8Koala.jpg', 1),
	(4, 1, 'bba3b8b4-a67b-4f9f-9948-6d411a6f6891Lighthouse.jpg', 0),
	(6, 1, '207f104f-e076-4476-bb55-398ca0dd39fePenguins.jpg', 0),
	(7, 2, 'ad7b560b-e39f-4aa9-903d-d4997a33a44bDesert.jpg', 1),
	(8, 2, '96e06b1a-2dfd-41c5-bc2c-778ffd7b9f36Chrysanthemum.jpg', 0),
	(9, 2, 'eaaf691a-5e10-472e-be60-0b33af9daaddLighthouse.jpg', 0),
	(10, 2, '499db134-bbda-4b9a-9809-264dd6af8c37Tulips.jpg', 0);
...
CREATE TABLE IF NOT EXISTS `pessoa` (
  ...
  `cliente` enum('S','N') NOT NULL default 'N' COMMENT 'campo utilizado para sinalizar se a pessoa que esta sendo cadastrada e cliente do proprietario do cadastro',
  ...
  `pontoReferecia` varchar(100) default NULL,
...
-- Dumping data for table dbopcaoimovel.pessoa: ~7 rows (approximately)
/*!40000 ALTER TABLE `pessoa` DISABLE KEYS */;
INSERT INTO `pessoa` (`idPessoa`, `idPessoaProprietario`, `cliente`, `razao`, `fantasia`, `genero`, `dtCadastro`, `dtUltimaAlteracao`, `logradouro`, `numLogradouro`, `complemento`, `pontoReferecia`, `bairro`, `cidade`, `uf`, `pais`, `observacao`, `visivel`, `telefone`, `fax`, `celular`, `email`, `site`) VALUES
	(1, 1, 'N', 'admin', 'admin', 'M', '0000-00-00 00:00:00', '2012-08-15 18:46:53', '1', 's/n', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL),
	(10, 13, 'N', 'Diego Henrique', 'Diego Henrique', 'M', '2012-08-02 19:28:24', '2012-08-16 10:55:30', '7', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 1, NULL, NULL, NULL, NULL, NULL),
	(11, 13, 'N', 'Rodolfo ', 'Rodolfo ', 'M', '2012-08-02 19:59:31', '2012-08-16 10:55:31', '8', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 1, NULL, NULL, NULL, NULL, NULL),
	(13, 13, 'N', 'Nova social', 'Nova fantasia', 'M', '2012-08-16 10:06:15', '2012-08-30 15:45:21', '10', NULL, NULL, 'Ponto', NULL, NULL, NULL, NULL, '', 1, NULL, NULL, NULL, NULL, 'www.i9pixel.com.br'),
	(16, 16, 'N', 'Padrão Imóveis', 'Padrão Imóveis', 'M', '2012-09-11 15:36:14', '2012-09-13 10:51:50', '13', NULL, NULL, '', NULL, NULL, NULL, NULL, '', 1, '8423445454', '', '', '', 'www.padraoimoveis.com.br'),
	(19, 16, 'S', 'Diego', 'Diego', 'M', '2012-09-13 18:37:40', '2012-09-13 18:37:40', '17', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 1, '8432063316', '', '8488070819', 'diehpb@gmail.com', NULL),
	(20, 20, 'N', 'Abreu Imóveis', '                    ', 'M', '2012-09-25 15:10:54', '2012-09-25 15:10:54', '18', NULL, NULL, 'Referência', NULL, NULL, NULL, NULL, '', 1, '8454523523', '', '', '', '');
...
-- Dumping data for table dbopcaoimovel.pessoafisica: ~3 rows (approximately)
...
INSERT INTO `usuario` (`idUsuario`, `idPessoa`, `idPapel`, `login`, `senha`, `logado`, `bloqueado`) VALUES
	(1, 1, 1, 'admin', 'eb0a191797624dd3a48fa681d3061212', 'N', 'N'),
	(2, 13, 2, 'imob', 'E7D80FFEEFA212B7C5C55700E4F7193E', 'N', 'N'),
	(3, 16, 2, 'padrãoImóveis', 'E8D95A51F3AF4A3B134BF6BB680A213A', 'N', 'N'),
	(4, 20, 2, 'abreu', 'E7D80FFEEFA212B7C5C55700E4F7193E', 'N', 'N');
