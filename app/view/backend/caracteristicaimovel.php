...
<form action="javascript: void(0)" id="frmCaracteristica" class="formpadrao">    
    <fieldset><h1 style="text-align: center;"><strong>Caracteristicas de imóveis cadastradas</strong></h1><hr /><br />
    <p><strong>Consultar caracteristica:</strong><br />
    ...
    <button id="btnNovo" class="button medium blue" name="btnNovo"><strong>Nova caracteristica</strong></button></p><br />
    <div id="dados">
    ...
    <div id="fundo" style="display: none;">
        <div id="janela" class="grid_12">
            <h1 style="text-align: center;"><strong>Cadastrar caracteristica</strong></h1>
...
<script type="text/javascript" src="js/caracteristicaImovel.js"></script>
</div>