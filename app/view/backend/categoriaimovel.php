...
<form action="javascript: void(0)" id="frmCategoriaImovel" class="formpadrao">    
    <fieldset><h1 style="text-align: center;"><strong>Categorias de imóveis cadastrados</strong></h1><hr /><br />
    <p><strong>Consultar categoria:</strong><br />
    ...
    <button id="btnNovo" class="button medium blue" name="btnNovo"><strong>Nova categoria</strong></button></p><br />
    <div id="dados">
        <div id="registros" style="text-align: right;">0 registro(s) encontrado(s).</div>
        <table id="tblCategorias" class="tabelapadrao ajustar">
            <thead>
            <tr>
                <th>#</th>
                <th>Descrição</th>                
    ...
    <div id="fundo" style="display: none;">
        <div id="janela" class="grid_12">
            <h1 style="text-align: center;"><strong>Cadastrar categoria</strong></h1>
...
<script type="text/javascript" src="js/categoriaImovel.js"></script>
</div>