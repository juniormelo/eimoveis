...
<?php if (Sessao::temPermissao('planocontaslista')) : ?>
        ...
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-xs-12"><br />
                    ...
                    <input type="text" id="txtConsulta" class="input-large" placeholder="Pesquisar plano de contas" />
                    ...
                    <button type="button" id="btnNovo" name="btnNovo" class="btn btn-success btn-sm">
                        <i class="ace-icon fa fa-pencil-square-o bigger-110"></i><strong>Novo plano de contas</strong>
                    </button>
                    <div id="registros" style="text-align: right; font-weight: bold; padding: 1% 1% 1% 1%; display: none">0 registro(s) encontrado(s).</div>
                    <table id="tblPlanos" class="table table-striped table-bordered table-hover" style="display: none">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Código</th>
